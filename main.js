...
const i18n = {
  ...
  strings: {
    pl: {
      navMenu:'Menu', navLocations:'Lokalizacje', navReviews:'Opinie', navFaq:'FAQ', navPress:'Prasa', navContact:'Kontakt',
      navCta:'Zamów teraz', langSwitch:'EN',
      heroEyebrow:'Autentyczny smak Bliskiego Wschodu',
      heroEst:'Warszawa · Est. Since 2004',
      ...
      heroVisualSub:'Warszawa · od 20 zł',
      ...
      menuSerNote1:'Dodatkowy ser +3 zł', menuSerNote2:'Dodatkowy ser +3 zł',
      menuDania:'Dania na Talerzu', menuWynos:'Na wynos +1 zł',
      faqEyebrow:'Najczęściej zadawane pytania', faqTitle:'Odpowiedzi',
      pressEyebrow:'Dla mediów i blogerów', pressTitle:'Prasa', pressAccent:'& Media',
      pressDesc:'Jesteś dziennikarzem, blogerem kulinarnym lub twórcą treści? Chętnie zaprosimy Cię na degustację.',
      pp1t:'Kontakt prasowy', pp1d:'Odpowiadamy na wszystkie zapytania mediów.',
      pp2t:'Zaproszenie na degustację', pp2d:'Blogerzy i twórcy są mile widziani.',
      pp3t:'Współpraca & partnerstwa', pp3d:'Catering, eventy, sponsoring, kolaboracje.',
      pressFactsLabel:'Kluczowe fakty o Kebab Dubai',
      pf1:'opinii na Google Maps', pf2:'średnia ocena (3 lokale)', pf3:'lokalizacje w Warszawie',
      pf4:'jeden lokal czynny całą dobę', pf5:'mięso halal', pf6:'kebab w picie od',
      pressEmbedLabel:'Polecasz nas? Dodaj odznakę do swojej strony',
      pressEmbedDesc:'Skopiuj kod HTML poniżej i wklej na swojej stronie.',
      badgeCodeLabel:'Kod HTML do skopiowania', copyCode:'Kopiuj', copiedCode:'Skopiowano ✓',
      featuredLabel:'Pisali o nas',
      pressYourLogo:'Twoje\nmedium',
      pressNote:'Zdjęcia w wysokiej rozdzielczości i materiały prasowe dostępne na życzenie.',
      platLabel:'Znajdź nas i zostaw opinię',
      footDirectories:'Oceń nas',
    ...
    en: {
      navMenu:'Menu', navLocations:'Locations', navReviews:'Reviews', navFaq:'FAQ', navPress:'Press', navContact:'Contact',
      navCta:'Order now', langSwitch:'PL',
      heroEyebrow:'Authentic Middle Eastern flavours',
      heroEst:'Warsaw · Est. Since 2004',
      ...
      heroVisualSub:'Warsaw · from 20 zł',
      ...
      pressEyebrow:'For media & bloggers', pressTitle:'Press', pressAccent:'& Media',
      pressDesc:'Are you a journalist, food blogger or content creator? We would love to invite you for a tasting.',
      pp1t:'Press contact', pp1d:'We respond to all media enquiries.',
      pp2t:'Tasting invitation', pp2d:'Bloggers and creators are very welcome.',
      pp3t:'Collaboration & partnerships', pp3d:'Catering, events, sponsorship, brand collabs.',
      pressFactsLabel:'Key facts about Kebab Dubai',
      pf1:'Google Maps reviews', pf2:'average rating (3 locations)', pf3:'locations in Warsaw',
      pf4:'one location open 24/7', pf5:'halal meat', pf6:'kebab wrap from',
      pressEmbedLabel:'Recommend us? Add our badge to your site',
      pressEmbedDesc:'Copy the HTML code below and paste it on your website.',
      badgeCodeLabel:'HTML code to copy', copyCode:'Copy', copiedCode:'Copied ✓',
      featuredLabel:'As featured in',
      pressYourLogo:'Your\nmedia',
      pressNote:'High-resolution photos and press materials available on request.',
      platLabel:'Find us & leave a review',
      footDirectories:'Rate us',
...
function initNavActive() {
  const ids = ['hero','menu','locations','reviews','faq','press','contact'], links = {};
...
function initBadgeCopy() {
  ...
  const code = document.getElementById('badge-code-text');
  if (!btn || !code) return;
  ...
  btn.addEventListener('click', async () => {
    ...
    const originalText = i18n.t('copyCode');
    const copiedText   = i18n.t('copiedCode');
    btn.classList.add('copied');
    if (label) label.textContent = copiedText;
    btn.setAttribute('aria-label', 'Kod skopiowany do schowka');
    setTimeout(() => {
      btn.classList.remove('copied');
      if (label) label.textContent = originalText;
      btn.setAttribute('aria-label', 'Skopiuj kod HTML odznaki do schowka');
    }, 2200);
  });
}
